import type { SelectOptionsType } from '../components/select/assets/types';

const countries: Array<SelectOptionsType> = [
  {
    label: 'Türkiye',
    value: 90,
  },
];
const cityList: Array<SelectOptionsType> = [
  { value: '1', label: 'Adana' },
...
const testList: Array<SelectOptionsType> = [
  {
    label: 'Oto yıkama',
    value: 2,
  },
...
export { cityList, countries, carsBrandsModels, testList };
